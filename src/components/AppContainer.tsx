...
export default function AppContainer(props: Props) {
    ...
    if (isMIDIReady) {
        return <Container maxWidth="md">
            <ExpansionPanel>
                <div className={`${classes.inputList} ${hasRecentInputListChange ? classes.inputListChanged : ""}`} onTransitionEnd={onInputListTransitionEnd}>
                    <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>MIDI Inputs</ExpansionPanelSummary>
                </div>
                <ExpansionPanelDetails><MidiInputs inputs={props.midiInputs}></MidiInputs></ExpansionPanelDetails>
            </ExpansionPanel>
            <ExpansionPanel>
                <div className={`${classes.eventList} ${hasNewEvent ? classes.eventListNewEvent : ""}`} onTransitionEnd={onEventPanelTransitionEnd}>
        ...
        return <Container maxWidth="md"> <div className={classes.progress}><CircularProgress /></div></Container >
    }
}